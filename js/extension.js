(() => {
            ...
            e.exports = function (e) {
                ...
                return n.toString = function () {
                    ...
                    for (var u = 0; u < e.length; u++) {
                        var d = [].concat(e[u]);
                        t && c[d[0]] || (void 0 !== a && (void 0 === d[5] || (d[1] = "@layer".concat(d[5].length > 0 ? " ".concat(d[5]) : "", " {").concat(d[1], "}")), d[5] = a), r && (d[2] ? (d[1] = "@media ".concat(d[2], " {").concat(d[1], "}"), d[2] = r) : d[2] = r), o && (d[4] ? (d[1] = "@supports (".concat(d[4], ") {").concat(d[1], "}"), d[4] = o) : d[4] = "".concat(o)), n.push(d))
                    }
                }, n
            }
        },
    ...
    }, r.o = (e, n) => Object.prototype.hasOwnProperty.call(e, n), r.nc = void 0;
    var t = r(72),
        o = r.n(t),
        a = r(825),
        c = r.n(a),
        ...
        b = r(901),
        m = {};
    m.styleTagTransform = v(), m.setAttributes = d(), m.insert = i().bind(null, "head"), m.domAPI = c(), m.insertStyleElement = f(), o()(b.A, m), b.A && b.A.locals && b.A.locals
})();